...
- (void)insertNewObject:(id)sender
{
    ...
    [newManagedObject setValue:@"Plain" forKey:@"presentationStyle"];
    [newManagedObject setValue:@"# Slide Number 1\nContent\n\n\n##Presenter Notes 1\nContent\n\n\n\n# Slide Number 2\nContent\n\n\n##Presenter Notes 2\nContent\n\n\n\n# Slide Number 3\nContent\n\n\n##Presenter Notes 3\nContent" forKey:@"presentationContent"];
