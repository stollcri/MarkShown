...
- (void)viewDidLoad
{
    ...
    // Disable swipe back to previous view controller,
    // so the presentation is not inadvertantly ended
    ...
    if ([self.tableView numberOfRowsInSection:0] <= 0) {
        ...
        MarkShow *newManagedObject = [NSEntityDescription insertNewObjectForEntityForName:[entity name] inManagedObjectContext:context];
        
        // If appropriate, configure the new managed object.
        newManagedObject.timeStamp = [NSDate date];
        newManagedObject.presentationName = @"MarkShown Tutorial";
        newManagedObject.presentationContent = TUTORIAL_PRESENTATION_CONTENT;
        newManagedObject.presentationCSS = DEFAULT_PRESENTATION_CSS;
...
- (void)insertNewObject:(id)sender
{
    ...
    newManagedObject.timeStamp = [NSDate date];
    newManagedObject.presentationName = @"New Presentation";
    newManagedObject.presentationContent = DEFAULT_PRESENTATION_CONTENT;
    newManagedObject.presentationCSS = DEFAULT_PRESENTATION_CSS;
...
- (void)prepareForSegue:(UIStoryboardSegue *)segue sender:(id)sender
{
    ...
    MarkShow *object = [[self fetchedResultsController] objectAtIndexPath:indexPath];
    
    // for V1 to V2 migration
    if (!object.presentationCSS) {
        object.presentationCSS = DEFAULT_PRESENTATION_CSS;
    }
...
- (void)configureCell:(UITableViewCell *)cell atIndexPath:(NSIndexPath *)indexPath
{
    ...
    cell.textLabel.text = object.presentationName;
